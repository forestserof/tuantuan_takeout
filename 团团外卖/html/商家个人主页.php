...
$query = "SELECT merchantName FROM merchants where merchantID=$merchantID";
...
<body>
    ...
    <div class="wrapper">
        <h2>修改个人信息</h2>
        <form method="post" action="../php/res_person.php"> <!-- 将 action 设置为后端处理修改个人信息的 PHP 文件 -->
    ...
    <div class="wrapper">
        <h2>修改密码</h2>
        <form method="post" action="../php/res_person.php">
