...
$query = "SELECT username,photo FROM users where userID=$userID";
...
<body>
    ...
    <div class="wrapper">
        <h2>修改个人信息</h2>
        <form method="post" action="../php/user_person.php"> <!-- 将 action 设置为后端处理修改个人信息的 PHP 文件 -->
    ...
    <div class="wrapper">
        <h2>修改头像</h2>
        <form method="post" action="../php/user_person.php" enctype="multipart/form-data"> <!-- 将 action 设置为后端处理修改头像的 PHP 文件，并添加 enctype 属性 -->
            <input type="file" name="avatar" accept="image/gif, image/jpeg, image/png,image/jpg">
            
            <button type="submit">保存</button>
            <input type="hidden" name="form_type" value="update_avatar"> <!-- 隐藏字段，指定表单类型为修改头像 -->
        </form>
    </div>
    
    <div class="wrapper">
        <h2>修改密码</h2>
        <form method="post" action="../php/user_person.php">
